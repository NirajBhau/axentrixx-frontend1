      ...
      <main className="pt-32">
        <section className="py-16 md:py-20 bg-gradient-to-br from-[#F8FAFC] via-[#EFF6FF] to-[#DBEAFE] dark:from-[#0F0F0F] dark:via-[#1A1A2E] dark:to-[#1E293B]">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            ...
            <div className="max-w-4xl">
              ...
              <h1 className="mb-6 font-bold leading-tight text-[#111] dark:text-white/90" style={{ fontFamily: '"Inter", sans-serif', fontSize: "clamp(32px, 5vw, 56px)", lineHeight: "1.2" }}>Business Intelligence</h1>
              <p className="text-[#606060] dark:text-white/60 text-lg mb-8" style={{ fontFamily: '"Inter", sans-serif', lineHeight: "1.7" }}>Empower your decision-making with comprehensive BI solutions that turn complex data into clear, actionable insights.</p>
        ...
        <section className="py-16 md:py-20 bg-white dark:bg-[#121212]">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {[
                { title: "Interactive dashboards and reports", description: "Real-time insights at your fingertips" },
                { title: "KPI tracking and monitoring", description: "Track what matters most to your business" },
                { title: "Data warehousing solutions", description: "Centralized data storage and management" },
                { title: "Self-service analytics tools", description: "Empower teams to explore data independently" },
              ].map((feature, index) => (
        ...
        <section className="py-16 md:py-20 bg-[#FAFAF6] dark:bg-[#1E1E1E]">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                { icon: Zap, title: "Fast Insights", description: "Real-time data analysis and reporting" },
        ...
        <section className="py-16 md:py-20 bg-white dark:bg-[#121212]">
          <div className="max-w-4xl mx-auto px-6 lg:px-12 text-center">
            <h2 className="mb-6 font-bold text-[#111] dark:text-white/90" style={{ fontFamily: '"Inter", sans-serif', fontSize: "clamp(28px, 3vw, 42px)" }}>Ready to Unlock Your Data?</h2>
            <p className="mb-8 text-[#606060] dark:text-white/60" style={{ fontFamily: '"Inter", sans-serif', fontSize: "18px" }}>Let's discuss your business intelligence needs.</p>
